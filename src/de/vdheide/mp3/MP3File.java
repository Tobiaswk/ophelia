...
public class MP3File extends java.io.File {
    ...
    private boolean illegalTags = false;
            ...
            if (brackpos != -1) {
                ...
                if (Character.isDigit(genre.getTextContent().charAt(
                    ...
                    if (brackclose == -1) {
                        ...
                        // parse to int
                        try {
                            Integer par = new Integer(genre.getTextContent().substring(
    ...
    public void setDate(TagContent date) throws TagFormatException {
        // check format
        if (date.getTextContent() == null || checkExactLength(date.getTextContent(), 4) == false || checkNumeric(date.getTextContent()) == false) {
            throw new TagFormatException();
        }
    ...
    public void setTime(TagContent time) throws TagFormatException {
        // check format
        if (time.getTextContent() == null || !checkExactLength(time.getTextContent(), 4) || !checkNumeric(time.getTextContent())) {
            throw new TagFormatException();
        }
    ...
    public void setOriginalYear(TagContent year)
            throws TagFormatException {
        // check format
        if (year.getTextContent() == null || !checkExactLength(year.getTextContent(), 4) || !checkNumeric(year.getTextContent())) {
            throw new TagFormatException();
        }
    ...
    public void setYear(TagContent year) throws TagFormatException {
        if (year.getTextContent() == null || !checkNumeric(year.getTextContent()) || (!checkMaxLength(year.getTextContent(), 4) && !checkMaxLength(
    ...
    public void setUniqueFileIdentifier(TagContent ufi)
        ...
        if (ufi.getDescription() == null || ufi.getBinaryContent() == null || checkMaxLength(ufi.getBinaryContent(), 64) == false) {
            throw new TagFormatException();
        }

        ByteBuilder build = new ByteBuilder(ByteBuilder.NONE, ufi.getDescription().length() + 2 + ufi.getBinaryContent().length);
    ...
    public void setUserDefinedText(TagContent info)
        ...
        ByteBuilder build = new ByteBuilder(ByteBuilder.UNICODE, info.getDescription().length() * 2 + 3 + info.getTextContent().length() * 2);
    ...
    public void setUserDefinedURL(TagContent link)
        ...
        ByteBuilder build = new ByteBuilder(ByteBuilder.UNICODE, link.getDescription().length() * 2 + 3 + link.getTextContent().length());
    ...
    public void setUnsynchronizedLyrics(TagContent lyric)
            throws TagFormatException {
        if (lyric.getType() == null || lyric.getDescription() == null || lyric.getTextContent() == null || !checkExactLength(lyric.getType(), 3)) {
            throw new TagFormatException();
        }

        ByteBuilder build = new ByteBuilder(ByteBuilder.UNICODE, 6 + lyric.getDescription().length() * 2 + lyric.getTextContent().length() * 2);
    ...
    public void setComments(TagContent comm) throws TagFormatException {
        if (comm.getType() == null || comm.getDescription() == null || comm.getTextContent() == null || !checkExactLength(comm.getType(), 3)) {
            throw new TagFormatException();
        }

        ByteBuilder build = new ByteBuilder(ByteBuilder.UNICODE, 4 + comm.getDescription().length() * 2 + comm.getTextContent().length() * 2);
    ...
    public void setPicture(TagContent pic) throws TagFormatException {
        ...
        ByteBuilder build = new ByteBuilder(ByteBuilder.UNICODE, 6 + pic.getType().length() + 1 + pic.getDescription().length() * 2 + pic.getBinaryContent().length);
    ...
    public void setEncapsulatedObject(TagContent obj)
        ...
        ByteBuilder build = new ByteBuilder(ByteBuilder.UNICODE, 6 + obj.getType().length() + obj.getTextSubtype().length() * 2 + obj.getDescription().length() * 2 + obj.getBinaryContent().length);
    ...
    public void setTermsOfUse(TagContent use) throws TagFormatException {
        if (use.getType() == null || use.getTextContent() == null || !checkExactLength(use.getType(), 3)) {
            throw new TagFormatException();
        }
    ...
    public void setEncryptionMethodRegistration(TagContent encr)
            throws TagFormatException {
        if (encr.getType() == null || encr.getBinarySubtype() == null || encr.getBinaryContent() == null || !checkExactLength(encr.getBinarySubtype(), 1)) {
            throw new TagFormatException();
        }

        ByteBuilder build = new ByteBuilder(ByteBuilder.NONE, 2 + encr.getType().length() + encr.getBinaryContent().length);
    ...
    public void setGroupIdentificationRegistration(TagContent grp)
            throws TagFormatException {
        if (grp.getType() == null || grp.getBinarySubtype() == null || grp.getBinaryContent() == null || !checkExactLength(grp.getBinarySubtype(), 1)) {
            throw new TagFormatException();
        }

        ByteBuilder build = new ByteBuilder(ByteBuilder.NONE, 2 + grp.getType().length() + grp.getBinaryContent().length);
    ...
    public void setPrivateData(TagContent data)
        ...
        ByteBuilder build = new ByteBuilder(ByteBuilder.NONE, 1 + data.getType().length() + data.getBinaryContent().length);
     ...
     * removed ID3v2DecompressionException and ID3v2IllegalVersionException
     * as thrown - try-catched now
     * 
     * @exception IOException
     *                If I/O error occurs
     * @exception NoMP3FrameException
    ...
    public String toString() {
         try {
        if (illegalTags || getArtist().getTextContent() == null) {
            return filePath.getName();
        }
            return "<html>" + getTrack().getTextContent() + ". " + getArtist().getTextContent() + " - " + getTitle().getTextContent() + " <i>(" + getAlbum().getTextContent() + ")</i> </html>";
