...
public class ID3 {
    ...
    public void readTag() throws NoID3TagException, IOException {
        ...
        // get access to file
        RandomAccessFile in = new RandomAccessFile(mediaFile, "r");
    ...
    public void writeTag() throws IOException {
        // get access to file
        RandomAccessFile in = new RandomAccessFile(mediaFile, "rw");
    ...
    protected File mediaFile = null; // file to access
